...
CREATE TABLE Payment (
    payment_id BIGINT AUTO_INCREMENT PRIMARY KEY, -- Unique payment ID
    booking_id BIGINT NOT NULL,            -- Linked booking (1 payment per booking)
...
-- Insert staff details (linked with Users)
...
(1, 1, '2025-10-01', '2025-10-05', 2, 'Checked-In', 1),
(2, 2, '2025-10-15', '2025-10-18', 1, 'Confirmed', 5),
(3, 4, '2025-09-28', '2025-10-03', 2, 'Checked-Out', 2),
(4, 3, '2025-10-20', '2025-10-22', 3, 'Confirmed', 8),
(5, 5, '2025-10-02', '2025-10-04', 1, 'Checked-In', 9),
(6, 6, '2025-09-25', '2025-09-30', 2, 'Checked-Out', 6),
(7, 8, '2025-10-25', '2025-10-30', 4, 'Confirmed', 3),
(8, 9, '2025-10-03', '2025-10-06', 1, 'Confirmed', 5),
(9, 10, '2025-10-07', '2025-10-10', 2, 'Confirmed', 1),
(10, 2, '2025-09-10', '2025-09-12', 1, 'Cancelled', 8);
INSERT INTO Bookings (guest_id, room_id, check_in_date, check_out_date, no_of_guests, booking_status, staff_id) VALUES
(1, 1, '2025-10-01', '2025-10-05', 2, 'Checked-In', 1),
(1, 2, '2025-10-01', '2025-10-05', 1, 'Checked-In', 1),  -- same guest, multiple rooms
(2, 3, '2025-10-15', '2025-10-18', 1, 'Confirmed', 5),
(3, 4, '2025-09-28', '2025-10-03', 2, 'Checked-Out', 2),
(4, 5, '2025-10-20', '2025-10-22', 3, 'Confirmed', 8),
(5, 6, '2025-10-02', '2025-10-04', 1, 'Checked-In', 9),
(6, 7, '2025-09-25', '2025-09-30', 2, 'Checked-Out', 6),
(7, 8, '2025-10-25', '2025-10-30', 4, 'Confirmed', 3),
(8, 9, '2025-10-03', '2025-10-06', 1, 'Confirmed', 5),
(9, 10, '2025-10-07', '2025-10-10', 2, 'Confirmed', 1),
(10, 2, '2025-09-10', '2025-09-12', 1, 'Cancelled', 8);
...
-- Insert booking services (extra services used in each booking)
